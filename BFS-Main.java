...
class Main {
	...
	public static void main(String[] args) {
		...
		//System.out.println("Is valid: "+initial.isStateValid(initial));
		System.exit(0);
	}
...
class BFS{
			...
			Board cV = copy(vertex);
				...
				for(int i = 0; i < move.ret.size(); i++){
					...
					if(!(visited.contains(move.ret.get(i)))){
						...
						//route.add(move.ret.get(i).state);
	...
	//		route.add(visited.pollLast().state);
